...
export function ArticleShareAction({
    ...
    if (window.innerWidth < 640 && navigator.share) {
      try {
        await navigator.share({
          title: title,
          text:
            excerpt || `Read ${title} on Malika Okubasu & Company Advocates`,
          url: shareUrl,
        });
  ...
  return (
    <section
      className="mt-14 sm:mt-16 article-share"
      aria-labelledby="share-heading"
    >
      <h2
        id="share-heading"
        className="mb-4 text-xl font-bold text-navy font-serif-editorial"
      >
        Share this article
      </h2>
      <button
          ...
          >
            <div className="flex flex-col h-full max-h-[90dvh] sm:max-h-[calc(100dvh-48px)]">
              ...
              <div className="shrink-0 flex flex-col border-b border-gray-100 bg-white">
                <div
                  className="mx-auto mt-3 h-1 w-10 rounded-full bg-gray-300 sm:hidden"
                  aria-hidden="true"
                />
                  ...
                  {modalView === "embed" ? (
                    <div className="flex items-center gap-2">
                      ...
                      <Dialog.Title
                        ...
                        className="text-lg font-bold text-navy border-l border-gray-200 pl-3"
                      >
                        Embed article
                      </Dialog.Title>
                    </div>
              ...
              <div className="flex-1 overflow-y-auto sm:overflow-visible p-5 sm:p-6">
                {modalView !== "embed" ? (
                  <>
                    ...
                    <div
                      aria-live="polite"
                      className="mb-4 h-5 text-center text-sm font-medium"
                    >
                      {statusMsg && (
                        <span
                          className={
                    ...
                    <div className="mb-2 flex overflow-x-auto snap-x snap-mandatory gap-2 pb-4 sm:grid sm:grid-cols-5 sm:gap-2 sm:overflow-visible sm:pb-0 scrollbar-hide relative">
                      ...
                      >
                        ...
                        <span className="text-xs font-medium text-gray-600 group-hover:text-navy">
                          Copy
                        </span>
                      </button>
                      ...
                      >
                        <div
                          className={`flex h-14 w-14 items-center justify-center rounded-2xl transition-colors ${modalView === "more" ? "bg-navy text-white" : "bg-gray-100 text-gray-700 group-hover:bg-gray-200 group-hover:text-navy"}`}
                        >
                          ...
                          <ul className="flex flex-col">
                            ...
                            <li role="none">
                              <button
                                role="menuitem"
                                onClick={() =>
                                  handleNativeShare("send_as_message")
                                }
                                className="flex min-h-[44px] w-full items-center gap-3 rounded-lg px-4 py-2.5 text-sm font-medium text-gray-700 transition-colors hover:bg-white sm:hover:bg-gray-50 hover:text-navy hover:shadow-sm sm:hover:shadow-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold"
                              >
                                <Send className="h-4 w-4 text-gray-500" /> Send
                                as message
                              </button>
                            </li>
                            <li role="none">
                  ...
                  <div className="flex flex-col">
                    ...
                    {statusMsg && statusMsg !== "Copied" && (
                      <div
                        aria-live="polite"
                        className="mt-2 h-5 text-sm font-medium"
                      >
