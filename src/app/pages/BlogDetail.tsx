...
const blogPosts: Record<string, {
  ...
  '1': {
    ...
    readTime: '8 min read',
    content: {
      introduction: 'The East African Community (EAC) presents unique opportunities and challenges for cross-border mergers and acquisitions. As regional economic integration deepens, understanding the regulatory framework across member states becomes increasingly critical for successful transactions.',
      sections: [
        {
      ...
      conclusion: 'Cross-border M&A in East Africa offers significant opportunities for companies seeking regional expansion and market consolidation. Success requires sophisticated legal expertise, early regulatory engagement, and careful attention to the unique characteristics of each jurisdiction. As the EAC integration process continues, we expect further harmonization of regulatory requirements, but local knowledge remains essential for navigating the current landscape.',
    },
  },
  '2': {
    id: 2,
    ...
    readTime: '6 min read',
    content: {
      introduction: 'Early-stage startups often prioritize product development and market traction over corporate governance. However, establishing strong governance foundations from the outset can prevent costly restructuring, facilitate fundraising, and position companies for sustainable growth in regulated markets.',
      sections: [
        {
          heading: 'Establishing a Proper Corporate Structure',
          paragraphs: [
            'Choosing the right legal entity is fundamental to your startup\'s governance framework. While sole proprietorships and partnerships offer simplicity, limited liability companies provide important protections and are generally preferred by investors.',
            'Your articles of incorporation and shareholders\' agreement should clearly define ownership rights, decision-making authority, and procedures for issuing new shares. Ambiguity in these foundational documents can lead to disputes that derail your business.',
            'Consider implementing a vesting schedule for founder shares to ensure long-term commitment and protect the company if a founder departs early. Standard vesting periods range from 3-4 years with a one-year cliff.',
          ],
        },
        {
          heading: 'Building an Effective Board',
          paragraphs: [
            'Even early-stage startups benefit from constituting a proper board of directors. A well-structured board brings expertise, accountability, and credibility that can accelerate growth and attract investment.',
            'Board composition should balance insider knowledge with independent judgment. Consider including at least one independent director with relevant industry or functional expertise, even before external funding.',
            'Establish clear board procedures including regular meeting schedules, quorum requirements, and decision-making protocols. Document all board resolutions properly and maintain comprehensive corporate records.',
          ],
        },
        {
          heading: 'Implementing Financial Controls',
          paragraphs: [
            'Proper financial management is essential for governance and compliance. Implement accounting systems that provide accurate, timely financial information and separate business finances completely from personal accounts.',
            'Establish approval hierarchies for different types of expenditures. Even small companies should require dual authorization for significant transactions and maintain clear documentation of all financial decisions.',
            'Regular financial reporting to shareholders and the board demonstrates transparency and builds trust. Monthly management accounts and quarterly board reports should become standard practice.',
          ],
        },
        {
          heading: 'Data Protection and Privacy Compliance',
          paragraphs: [
            'Data protection regulations increasingly apply to startups from day one. Understand your obligations under applicable laws and implement appropriate technical and organizational measures to protect personal data.',
            'Appoint a data protection officer or designate responsibility for privacy compliance. Conduct data mapping exercises to understand what personal data you collect, how you use it, and where it is stored.',
            'Privacy policies, data processing agreements, and consent mechanisms must comply with legal requirements. These should be reviewed by legal counsel and updated as your business model evolves.',
          ],
        },
        {
          heading: 'Intellectual Property Protection',
          paragraphs: [
            'Establish clear IP ownership from the outset. Ensure all founders, employees, and contractors sign IP assignment agreements that transfer ownership of work product to the company.',
            'Implement confidentiality and invention assignment clauses in employment agreements. Consider requiring employees to disclose pre-existing IP to avoid future ownership disputes.',
            'Register trademarks early and consider patent protection for novel inventions. Maintain comprehensive records of IP development to establish priority and ownership if challenged.',
          ],
        },
      ],
      conclusion: 'Strong corporate governance is not just about compliance—it\'s about building a sustainable business that can scale, attract investment, and withstand challenges. While governance requirements may seem burdensome for early-stage startups, the investment in proper structures and processes pays dividends throughout your company\'s lifecycle. Start with the fundamentals, seek expert guidance when needed, and view governance as a competitive advantage rather than a burden.',
    },
  },
  '3': {
    id: 3,
    ...
    readTime: '7 min read',
    content: {
      introduction: 'The digital transformation of business has fundamentally changed how companies create, use, and protect intellectual property. Traditional IP frameworks must now address challenges including digital piracy, cross-border infringement, and the protection of data-driven innovations that blur conventional IP categories.',
      sections: [
        {
      ...
      conclusion: 'Protecting intellectual property in the digital age requires combining traditional legal tools with technological solutions and strategic business practices. Companies must move beyond reactive enforcement toward proactive IP strategies that align with digital business models. As technology continues to evolve, staying informed about legal developments and maintaining flexibility in IP strategies will be essential for preserving competitive advantage.',
    },
  },
  '4': {
    id: 4,
    ...
    readTime: '7 min read',
    content: {
      introduction: 'The widespread adoption of remote work has created new legal challenges for employers. From tax obligations and labor law compliance to data security and workplace safety, managing distributed teams requires understanding complex and evolving legal frameworks across multiple jurisdictions.',
      sections: [
        {
  ...
  '5': {
    ...
    author: {
      ...
      title: 'Partner, Real Estate & Finance',
    },
    ...
    content: {
      ...
      conclusion: 'REITs represent an important innovation for East African real estate markets, offering liquidity, diversification, and professional management to investors while providing developers with alternative capital sources. Despite current challenges, the long-term outlook remains positive as regulatory frameworks mature, institutional capacity develops, and investor awareness grows. Success will require patience, strong governance, and realistic expectations about market development timelines.',
    },
  },
  '6': {
    id: 6,
    ...
    author: {
      ...
      title: 'Partner, Dispute Resolution',
    },
    ...
    return (
      <div className="lg:pt-[88px] pt-[72px] min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-[#0B1E3A] mb-4">Article Not Found</h1>
          <Link href="/publications" className="text-[#0B1E3A] hover:underline underline-offset-4">
    ...
    <div className="lg:pt-[88px] pt-[72px]">
      ...
      <section className="bg-white py-6 border-b border-[#E5E7EB]">
        <div className="max-w-[900px] mx-auto px-6 lg:px-12">
          <Link 
            href="/publications" 
            className="inline-flex items-center gap-2 text-[#5B6676] hover:text-[#0B1E3A] transition-colors group"
          >
        ...
        <div className="max-w-[900px] mx-auto px-6 lg:px-12">
          ...
          <div className="flex gap-3 mb-6">
            {post.tags.map((tag) => (
              <span
                key={tag}
                className="text-xs uppercase tracking-wider text-[#5B6676] font-semibold"
              >
                {tag}
              </span>
            ))}
          ...
          {/* Title */}
          <h1 className="text-3xl lg:text-5xl font-bold text-[#0B1E3A] mb-6 leading-tight font-serif-editorial">
            {post.title}
          </h1>
          ...
          <div className="flex items-center gap-6 mb-8 pb-8 border-b border-[#E5E7EB]">
            ...
            <div className="text-sm text-[#5B6676]">{post.date}</div>
            <div className="h-8 w-px bg-[#E5E7EB]" />
            <div className="text-sm text-[#5B6676]">{post.readTime}</div>
          </div>

          {/* Introduction */}
          <div className="prose prose-lg max-w-none mb-12">
            <p className="text-xl leading-relaxed text-[#0B1E3A] font-serif-editorial">
          ...
          <div className="space-y-12">
            {post.content.sections.map((section, index) => (
              <div key={index}>
                ...
                <h2 className="text-2xl lg:text-3xl font-bold text-[#0B1E3A] mb-6 font-serif-editorial">
                  {section.heading}
                </h2>
                <div className="space-y-6">
                  {section.paragraphs.map((paragraph, pIndex) => (
                    <p key={pIndex} className="text-lg leading-relaxed text-[#5B6676]">
                      {paragraph}
                    </p>
                  ))}
                </div>
          ...
          <div className="mt-12 pt-12 border-t border-[#E5E7EB]">
            ...
            <p className="text-lg leading-relaxed text-[#5B6676]">
              {post.content.conclusion}
            </p>
          </div>

          {/* Author Bio */}
          <div className="mt-16 p-8 bg-[#F2F4F7] border-l-4 border-[#0B1E3A]">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <div className="text-sm text-[#5B6676] mb-3">
                  {post.author.title}
                </div>
                <p className="text-sm text-[#5B6676] leading-relaxed">
                  {post.author.name} is a {post.author.title} at Malika Okubasu & Company Advocates, 
                  specializing in {post.tags.join(', ').toLowerCase()}. With extensive experience 
                  advising clients across East Africa, {post.author.name.split(' ')[0]} brings 
                  practical insights to complex legal challenges.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-16 text-center">
            <p className="text-lg text-[#5B6676] mb-6">
              Need expert legal guidance on this topic?
            </p>
            <Link
              href="/contact"
              className="inline-block bg-[#0B1E3A] text-white px-8 py-4 hover:bg-[#132B4C] transition-colors"
            >
              Get In Touch
            </Link>
          </div>
