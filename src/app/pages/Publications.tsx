                    ...
                    <div className="order-2 lg:order-1 flex flex-col justify-center">
                      ...
                      <div className="flex gap-2 mb-4">
                        {insight.tags.map((tag) => (
                          <span
                            key={tag}
                            className="text-xs uppercase tracking-wider text-body group-hover:text-link transition-colors"
                          >
                            {tag}
                          </span>
                        ))}
                      ...
                      {/* Title */}
                      <h2 className="text-2xl lg:text-4xl font-bold text-heading mb-4 leading-tight group-hover:underline underline-offset-4 transition-all">
                        {insight.title}
                      </h2>

                      {/* Excerpt */}
                      <p className="text-lg text-body mb-6 leading-relaxed line-clamp-2">
                        {insight.excerpt}
                      </p>
          ...
          <div className="mt-16 flex justify-center">
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-4 py-2 text-heading disabled:text-body disabled:cursor-not-allowed hover:underline underline-offset-4"
              >
                Previous
              </button>
                  ...
                  <button
                    ...
                    className={`w-10 h-10 flex items-center justify-center transition-colors ${
                      currentPage === page
                        ...
                        : "text-heading hover:bg-soft-blue"
                    }`}
                  >
                    {page}
                  </button>
                ))}
                <span className="w-10 h-10 flex items-center justify-center text-body">
                  ...
                </span>
                <button
              ...
              <button
                ...
                className="px-4 py-2 text-heading hover:underline underline-offset-4"
              >
                Next
              </button>
            </div>
