              ...
              <div className="flex flex-col gap-6 mb-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+254141397048" className="text-body hover:text-link hover:underline">
                      +254 141 397 048
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@malikaokubasu.com" className="text-body hover:text-link hover:underline">
              ...
              <div className="bg-soft-blue p-8 lg:p-10">
                ...
                {isSubmitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 bg-white border ${
                          errors.fullName ? 'border-error' : 'border-form-border'
                    ...
                    {/* Phone */}
                    <div>
                      <label htmlFor="phone" className="block text-sm font-bold text-heading mb-2">
                        Phone
                      </label>
                      <input
                        id="phone"
                    ...
                    {/* Subject */}
                    <div>
                      <label htmlFor="subject" className="block text-sm font-bold text-heading mb-2">
                        Subject
                      </label>
                      <input
                        id="subject"
                    ...
                    {/* Message */}
                    <div>
                      <label htmlFor="message" className="block text-sm font-bold text-heading mb-2">
                    ...
                    <div>
                      ...
                      {errors.consent && (
                        <p className="text-sm text-error mt-1">{errors.consent}</p>
                      )}
                    </div>
