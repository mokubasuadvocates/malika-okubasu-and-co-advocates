...
export default function CookiePolicyPage() {
  return (
    <main id="main-content" className="min-h-[100dvh] bg-white py-12 lg:py-16">
      <div className="mx-auto max-w-4xl px-6 lg:px-12">
        ...
        <div className="prose prose-lg max-w-none text-body">
          <section className="mb-10">
            ...
            <p className="mb-4">
              Malika Okubasu & Company Advocates (&quot;we,&quot;
              &quot;us,&quot; or &quot;our&quot;) uses cookies and similar
              tracking technologies on our website (mokubasuadvocates.com). This
          ...
          <section className="mb-10">
            ...
            <p className="mb-4">
              ...
              widely used by website owners to make their websites work securely
              and more efficiently, as well as to provide reporting information
              and enhanced functionality.
            </p>
            <p className="mb-4">
              Cookies set by the website owner (in this case, Malika Okubasu &
              Company Advocates) are called &quot;first-party cookies.&quot;
              ...
              the website (e.g., analytics and interactive content).
            </p>
          </section>
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-md border border-navy/10 p-5">
                ...
                <p className="mb-0 text-sm">
                  ...
                  pages. If you do not allow these cookies, some or all of these
              ...
              <div className="rounded-md border border-navy/10 p-5">
                ...
                <p className="mb-0 text-sm">
                  We may use advertising or remarketing cookies only where such
                  tools are enabled and where required consent has been
                  obtained. If active, these cookies may be set through our site
                  by our advertising partners to build a profile of your
          ...
          <section className="mb-10">
            ...
            <p className="mb-4">
              ...
              cookies. You can exercise your cookie preferences when you first
              visit our website via the cookie consent banner.
            </p>
            <p className="mb-4">
              You can also modify your preferences at any time by selecting the
              floating Cookie Settings icon, shown as a shield button at the
              bottom-left of the page after you make a choice. This will reopen
              the consent modal, allowing you to toggle categories on or off.
            </p>
            <p className="mb-4">
              In addition, most web browsers allow you to control cookies
              through their settings preferences. Please note that if you choose
              to reject cookies via your browser settings, you may still use our
          ...
          <section className="mb-10">
            ...
            <p className="mb-4">
              As described in our Privacy Policy, we use third-party services
              that may place cookies on your device, subject to your consent
              preferences. These include:
            </p>
            <ul className="mb-4 list-disc pl-6">
              <li>
                <strong>Google Analytics / Google Tag Manager:</strong> Used for
                analytical and performance tracking. We use Google Consent Mode
                to ensure these cookies only fire if you have granted analytics
                consent.
              </li>
              <li>
                <strong>Microsoft Clarity:</strong> Used to understand how users
                interact with our website. Data collected is anonymous and
                respects your consent preferences.
              </li>
            </ul>
          </section>
